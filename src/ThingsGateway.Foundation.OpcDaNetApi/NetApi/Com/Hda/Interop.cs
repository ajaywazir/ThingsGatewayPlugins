          ...
          bool deallocate)
        {
            ...
            if (pInput != IntPtr.Zero && count > 0)
            {
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    pInput1 = (nint)(pInput1.ToInt64() + (long)Marshal.SizeOf(typeof(OPCHDA_ITEM)));
                }
                if (deallocate)
                {
          ...
          bool deallocate)
        {
            ...
            if (pInput != IntPtr.Zero && count > 0)
            {
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    pInput1 = (nint)(pInput1.ToInt64() + (long)Marshal.SizeOf(typeof(OPCHDA_MODIFIEDITEM)));
                }
                if (deallocate)
                {
                    Marshal.FreeCoTaskMem(pInput);
          ...
          bool deallocate)
        {
            ...
            if (pInput != IntPtr.Zero && count > 0)
            {
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    pInput1 = (nint)(pInput1.ToInt64() + (long)Marshal.SizeOf(typeof(OPCHDA_ATTRIBUTE)));
                }
                if (deallocate)
                {
                    Marshal.FreeCoTaskMem(pInput);
          ...
          bool deallocate)
        {
            ...
            if (pInput != IntPtr.Zero && count > 0)
            {
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    pInput1 = (nint)(pInput1.ToInt64() + (long)Marshal.SizeOf(typeof(OPCHDA_ANNOTATION)));
                }
                if (deallocate)
                {
                    Marshal.FreeCoTaskMem(pInput);
