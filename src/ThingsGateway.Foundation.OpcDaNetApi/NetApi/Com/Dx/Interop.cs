          ...
          bool deallocate)
        {
            ...
            if (pInput != IntPtr.Zero && count > 0)
            {
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    ptr = (nint)(ptr.ToInt64() + (long)Marshal.SizeOf(typeof(OpcRcw.Dx.SourceServer)));
                }
                if (deallocate)
                {
          ...
          bool deallocate)
        {
            ...
            if (pInput != IntPtr.Zero && count > 0)
            {
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    ptr = (nint)(ptr.ToInt64() + (long)Marshal.SizeOf(typeof(OpcRcw.Dx.IdentifiedResult)));
                }
                if (deallocate)
                {
                    Marshal.FreeCoTaskMem(pInput);
          ...
          bool deallocate)
        {
            ...
            if (pInput != IntPtr.Zero && count > 0)
            {
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    ptr = (nint)(ptr.ToInt64() + (long)Marshal.SizeOf(typeof(OpcRcw.Dx.DXConnection)));
                }
                if (deallocate)
                {
                    Marshal.FreeCoTaskMem(pInput);
