  ...
  public class Server : OpcCom.Da.Server, Opc.Dx.IServer, Opc.Da.IServer, Opc.IServer, IDisposable
  {
    ...
    public Opc.Dx.SourceServer[] GetSourceServers()
    {
      lock (this)
      {
        ...
        try
        {
          ...
          ((IOPCConfiguration) this.m_server).GetServers(out pdwCount, out ppServers);
    ...
    public GeneralResponse AddSourceServers(Opc.Dx.SourceServer[] servers)
    {
      lock (this)
      {
        ...
        try
        {
          ...
          ((IOPCConfiguration) this.m_server).AddServers(sourceServers.Length, sourceServers, out pResponse);
    ...
    public GeneralResponse ModifySourceServers(Opc.Dx.SourceServer[] servers)
    {
      lock (this)
      {
        ...
        try
        {
          OpcRcw.Dx.SourceServer[] sourceServers = Interop.GetSourceServers(servers);
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).ModifyServers(sourceServers.Length, sourceServers, out pResponse);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
        {
    ...
    public GeneralResponse DeleteSourceServers(Opc.Dx.ItemIdentifier[] servers)
    {
      lock (this)
      {
        ...
        try
        {
          ...
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).DeleteServers(itemIdentifiers.Length, itemIdentifiers, out pResponse);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
        {
      ...
      Opc.Dx.ItemIdentifier[] servers)
    {
      lock (this)
      {
        ...
        try
        {
          OpcRcw.Dx.ItemIdentifier[] itemIdentifiers = Interop.GetItemIdentifiers(servers);
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).CopyDefaultServerAttributes(configToStatus ? 1 : 0, itemIdentifiers.Length, itemIdentifiers, out pResponse);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
        {
      ...
      out ResultID[] errors)
    {
      lock (this)
      {
        ...
        try
        {
          OpcRcw.Dx.DXConnection[] pDXConnectionMasks = Interop.GetDXConnections(connectionMasks) ?? new OpcRcw.Dx.DXConnection[0];
          int pdwCount = 0;
          IntPtr ppErrors = IntPtr.Zero;
          IntPtr ppConnections = IntPtr.Zero;
          ((IOPCConfiguration) this.m_server).QueryDXConnections(browsePath != null ? browsePath : "", pDXConnectionMasks.Length, pDXConnectionMasks, recursive ? 1 : 0, out ppErrors, out pdwCount, out ppConnections);
    ...
    public GeneralResponse AddDXConnections(Opc.Dx.DXConnection[] connections)
    {
      lock (this)
      {
        ...
        try
        {
          OpcRcw.Dx.DXConnection[] pConnections = Interop.GetDXConnections(connections) ?? new OpcRcw.Dx.DXConnection[0];
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).AddDXConnections(pConnections.Length, pConnections, out pResponse);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
        {
    ...
    public GeneralResponse ModifyDXConnections(Opc.Dx.DXConnection[] connections)
    {
      lock (this)
      {
        ...
        try
        {
          OpcRcw.Dx.DXConnection[] pDXConnectionDefinitions = Interop.GetDXConnections(connections) ?? new OpcRcw.Dx.DXConnection[0];
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).ModifyDXConnections(pDXConnectionDefinitions.Length, pDXConnectionDefinitions, out pResponse);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
        {
      ...
      out ResultID[] errors)
    {
      lock (this)
      {
        ...
        try
        {
          ...
          IntPtr ppErrors = IntPtr.Zero;
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).UpdateDXConnections(browsePath != null ? browsePath : "", pDXConnectionMasks.Length, pDXConnectionMasks, recursive ? 1 : 0, ref dxConnection, out ppErrors, out pResponse);
          errors = Interop.GetResultIDs(ref ppErrors, pDXConnectionMasks.Length, true);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
      ...
      out ResultID[] errors)
    {
      lock (this)
      {
        ...
        try
        {
          ...
          IntPtr ppErrors = IntPtr.Zero;
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).DeleteDXConnections(browsePath != null ? browsePath : "", pDXConnectionMasks.Length, pDXConnectionMasks, recursive ? 1 : 0, out ppErrors, out pResponse);
          errors = Interop.GetResultIDs(ref ppErrors, pDXConnectionMasks.Length, true);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
      ...
      out ResultID[] errors)
    {
      lock (this)
      {
        ...
        try
        {
          ...
          IntPtr ppErrors = IntPtr.Zero;
          DXGeneralResponse pResponse;
          ((IOPCConfiguration) this.m_server).CopyDXConnectionDefaultAttributes(configToStatus ? 1 : 0, browsePath != null ? browsePath : "", pDXConnectionMasks.Length, pDXConnectionMasks, recursive ? 1 : 0, out ppErrors, out pResponse);
          errors = Interop.GetResultIDs(ref ppErrors, pDXConnectionMasks.Length, true);
          return Interop.GetGeneralResponse(pResponse, true);
        }
        catch (Exception ex)
    ...
    public string ResetConfiguration(string configurationVersion)
    {
      lock (this)
      {
        ...
        try
        {
          ...
          ((IOPCConfiguration) this.m_server).ResetConfiguration(configurationVersion, out pszConfigurationVersion);
