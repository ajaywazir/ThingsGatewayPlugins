  ...
  public class Server : OpcCom.Server, Opc.Ae.IServer, Opc.IServer, IDisposable
  {
    ...
    public ServerStatus GetStatus()
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).GetStatus(out ppEventServerStatus);
        }
        catch (Exception ex)
        {
    ...
    public ISubscription CreateSubscription(SubscriptionState state)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).CreateEventSubscription(state.Active ? 1 : 0, state.BufferTime, state.MaxSize, ++this.m_handles, ref guid, out ppUnk, out pdwRevisedBufferTime, out pdwRevisedMaxSize);
        }
        catch (Exception ex)
        {
        ...
        this.m_subscriptions.Add((object) this.m_handles, (object) subscription);
    ...
    public int QueryAvailableFilters()
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).QueryAvailableFilters(out pdwFilterMask);
        }
        catch (Exception ex)
        {
    ...
    public Category[] QueryEventCategories(int eventType)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).QueryEventCategories(eventType, out pdwCount, out ppdwEventCategories, out ppszEventCategoryDescs);
        }
        catch (Exception ex)
        {
    ...
    public string[] QueryConditionNames(int eventCategory)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).QueryConditionNames(eventCategory, out pdwCount, out ppszConditionNames);
        }
        catch (Exception ex)
        {
    ...
    public string[] QuerySubConditionNames(string conditionName)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).QuerySubConditionNames(conditionName, out pdwCount, out ppszSubConditionNames);
        }
        catch (Exception ex)
        {
    ...
    public string[] QueryConditionNames(string sourceName)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).QuerySourceConditions(sourceName, out pdwCount, out ppszConditionNames);
        }
        catch (Exception ex)
        {
    ...
    public Opc.Ae.Attribute[] QueryEventAttributes(int eventCategory)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).QueryEventAttributes(eventCategory, out pdwCount, out ppdwAttrIDs, out ppszAttrDescs, out ppvtAttrTypes);
        }
        catch (Exception ex)
        {
      ...
      int[] attributeIDs)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).TranslateToItemIDs(sourceName != null ? sourceName : "", eventCategory, conditionName != null ? conditionName : "", subConditionName != null ? subConditionName : "", length, length > 0 ? attributeIDs : new int[0], out ppszAttrItemIDs, out ppszNodeNames, out ppCLSIDs);
        }
        catch (Exception ex)
        {
    ...
    public Condition GetConditionState(string sourceName, string conditionName, int[] attributeIDs)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).GetConditionState(sourceName != null ? sourceName : "", conditionName != null ? conditionName : "", attributeIDs != null ? attributeIDs.Length : 0, attributeIDs != null ? attributeIDs : new int[0], out ppConditionState);
        }
        catch (Exception ex)
        {
    ...
    public ResultID[] EnableConditionByArea(string[] areas)
    {
      lock (this)
      {
        ...
        if (this.m_supportsAE11)
        {
          try
          {
            ((IOPCEventServer2) this.m_server).EnableConditionByArea2(areas.Length, areas, out ppErrors);
          }
          catch (Exception ex)
          {
        ...
        else
        {
          try
          {
            ((IOPCEventServer) this.m_server).EnableConditionByArea(areas.Length, areas);
          }
          catch (Exception ex)
          {
    ...
    public ResultID[] DisableConditionByArea(string[] areas)
    {
      lock (this)
      {
        ...
        if (this.m_supportsAE11)
        {
          try
          {
            ((IOPCEventServer2) this.m_server).DisableConditionByArea2(areas.Length, areas, out ppErrors);
          }
          catch (Exception ex)
          {
        ...
        else
        {
          try
          {
            ((IOPCEventServer) this.m_server).DisableConditionByArea(areas.Length, areas);
          }
          catch (Exception ex)
          {
    ...
    public ResultID[] EnableConditionBySource(string[] sources)
    {
      lock (this)
      {
        ...
        if (this.m_supportsAE11)
        {
          try
          {
            ((IOPCEventServer2) this.m_server).EnableConditionBySource2(sources.Length, sources, out ppErrors);
          }
          catch (Exception ex)
          {
        ...
        else
        {
          try
          {
            ((IOPCEventServer) this.m_server).EnableConditionBySource(sources.Length, sources);
          }
          catch (Exception ex)
          {
    ...
    public ResultID[] DisableConditionBySource(string[] sources)
    {
      lock (this)
      {
        ...
        if (this.m_supportsAE11)
        {
          try
          {
            ((IOPCEventServer2) this.m_server).DisableConditionBySource2(sources.Length, sources, out ppErrors);
          }
          catch (Exception ex)
          {
        ...
        else
        {
          try
          {
            ((IOPCEventServer) this.m_server).DisableConditionBySource(sources.Length, sources);
          }
          catch (Exception ex)
          {
    ...
    public EnabledStateResult[] GetEnableStateByArea(string[] areas)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer2) this.m_server).GetEnableStateByArea(areas.Length, areas, out pbEnabled, out pbEffectivelyEnabled, out ppErrors);
        }
        catch (Exception ex)
        {
    ...
    public EnabledStateResult[] GetEnableStateBySource(string[] sources)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer2) this.m_server).GetEnableStateBySource(sources.Length, sources, out pbEnabled, out pbEffectivelyEnabled, out ppErrors);
        }
        catch (Exception ex)
        {
      ...
      EventAcknowledgement[] conditions)
    {
      lock (this)
      {
        ...
        try
        {
          ((IOPCEventServer) this.m_server).AckCondition(conditions.Length, acknowledgerID, comment, pszSource, szConditionName, pftActiveTime, pdwCookie, out ppErrors);
        }
        catch (Exception ex)
        {
    ...
    public BrowseElement[] Browse(string areaID, BrowseType browseType, string browseFilter)
    {
      lock (this)
      {
        ...
        BrowseElement[] browseElementArray = this.Browse(areaID, browseType, browseFilter, 0, out position);
        position?.Dispose();
      ...
      out IBrowsePosition position)
    {
      ...
      lock (this)
      {
        ...
        System.Runtime.InteropServices.ComTypes.IEnumString enumerator = (System.Runtime.InteropServices.ComTypes.IEnumString) this.CreateEnumerator(browseType, browseFilter);
    ...
    public BrowseElement[] BrowseNext(int maxElements, ref IBrowsePosition position)
    {
      lock (this)
      {
        ...
        this.InitializeBrowser();
        this.ChangeBrowsePosition(((Opc.Ae.BrowsePosition) position).AreaID);
        System.Runtime.InteropServices.ComTypes.IEnumString enumerator = ((BrowsePosition) position).Enumerator;
        ArrayList elements = new ArrayList();
        if (this.FetchElements(((Opc.Ae.BrowsePosition) position).BrowseType, maxElements, enumerator, elements) != 0)
        {
          position.Dispose();
          position = (IBrowsePosition) null;
        }
    ...
    private void InitializeBrowser()
    {
      ...
      try
      {
        ((IOPCEventServer) this.m_server).CreateAreaBrowser(ref guid, out ppUnk);
      }
      catch (Exception ex)
      {
        throw OpcCom.Interop.CreateException("IOPCEventServer.CreateAreaBrowser", ex);
      }
      this.m_browser = ppUnk != null ? ppUnk : throw new InvalidResponseException("unknown == null");
    }
    ...
    private object CreateEnumerator(BrowseType browseType, string browseFilter)
    {
      ...
      try
      {
        ((IOPCEventAreaBrowser) this.m_browser).BrowseOPCAreas(browseType1, browseFilter != null ? browseFilter : "", out ppIEnumString);
      }
      catch (Exception ex)
      {
    ...
    private string GetQualifiedName(string name, BrowseType browseType)
    {
      ...
      if (browseType == BrowseType.Area)
      {
        try
        {
          ((IOPCEventAreaBrowser) this.m_browser).GetQualifiedAreaName(name, out qualifiedName);
        }
        catch (Exception ex)
        {
      ...
      else
      {
        try
        {
          ((IOPCEventAreaBrowser) this.m_browser).GetQualifiedSourceName(name, out qualifiedName);
        }
        catch (Exception ex)
        {
      ...
      try
      {
        ...
        for (num2 = enumerator.Next(celt1, rgelt, num1); num2 == 0; num2 = enumerator.Next(celt2, rgelt, num1))
        {
          ...
          for (int index = 0; index < num3; ++index)
            ...
            {
              Name = rgelt[index],
              QualifiedName = this.GetQualifiedName(rgelt[index], browseType),
              NodeType = browseType
            });
