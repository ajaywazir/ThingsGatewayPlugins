  ...
  public class Interop
  {
    ...
    public static string[] EnumComputers()
    {
      ...
      for (int index = 0; index < entriesread; ++index)
      {
        ...
        ptr = (IntPtr) (ptr.ToInt64() + (long) Marshal.SizeOf(typeof (Interop.SERVER_INFO_100)));
      }
      Interop.NetApiBufferFree(bufptr);
      return strArray;
    }
    ...
    public static string GetSystemMessage(int error)
    {
      ...
      Interop.FormatMessageW(4096, IntPtr.Zero, error, 0, num, 1023, IntPtr.Zero);
    ...
    public static IntPtr GetUnicodeStrings(string[] values)
    {
      ...
      IntPtr destination = Marshal.AllocCoTaskMem(values.Length * Marshal.SizeOf(typeof (IntPtr)));
    ...
    public static IntPtr GetFILETIMEs(DateTime[] datetimes)
    {
      ...
      for (int index = 0; index < length; ++index)
      {
        ...
        ptr = (IntPtr) (ptr.ToInt64() + (long) Marshal.SizeOf(typeof (FILETIME)));
      }
      return filetimEs;
    }
    ...
    public static DateTime[] GetFILETIMEs(ref IntPtr pArray, int size, bool deallocate)
    {
      ...
      for (int index = 0; index < size; ++index)
      {
        ...
        pFiletime = (IntPtr) (pFiletime.ToInt64() + (long) Marshal.SizeOf(typeof (FILETIME)));
      }
      if (deallocate)
      {
        Marshal.FreeCoTaskMem(pArray);
    ...
    public static Guid[] GetGUIDs(ref IntPtr pInput, int size, bool deallocate)
    {
      ...
      for (int index = 0; index < size; ++index)
      {
        ...
        num = (IntPtr) (num.ToInt64() + (long) Marshal.SizeOf(typeof (Interop.GUID)));
      }
      if (deallocate)
      {
    ...
    public static IntPtr GetVARIANTs(object[] values, bool preprocess)
    {
      ...
      for (int index = 0; index < length; ++index)
      {
        ...
        pDstNativeVariant = (IntPtr) (pDstNativeVariant.ToInt64() + (long) Interop.VARIANT_SIZE);
      }
      return varianTs;
    }
    ...
    public static object[] GetVARIANTs(ref IntPtr pArray, int size, bool deallocate)
    {
      ...
      for (int index = 0; index < size; ++index)
      {
        ...
        num = (IntPtr) (num.ToInt64() + (long) Interop.VARIANT_SIZE);
      }
      if (deallocate)
      {
        Marshal.FreeCoTaskMem(pArray);
    ...
    private class ServerInfo
    {
      ...
      public Interop.COSERVERINFO Allocate(string hostName, NetworkCredential credential)
      {
        ...
        this.m_hUserName = GCHandle.Alloc((object) str1, GCHandleType.Pinned);
        this.m_hPassword = GCHandle.Alloc((object) str2, GCHandleType.Pinned);
        this.m_hDomain = GCHandle.Alloc((object) str3, GCHandleType.Pinned);
        this.m_hIdentity = new GCHandle();
        if (str1 != null && str1 != string.Empty)
          this.m_hIdentity = GCHandle.Alloc((object) new Interop.COAUTHIDENTITY()
          {
        ...
        this.m_hAuthInfo = GCHandle.Alloc((object) new Interop.COAUTHINFO()
        {
          dwAuthnSvc = 10U,
          dwAuthzSvc = 0U,
