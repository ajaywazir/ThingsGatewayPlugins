...
namespace OpcRcw.Ae
{
  ...
  public interface IOPCEventServer2
  {
    ...
    void EnableConditionByArea2([MarshalAs(UnmanagedType.I4)] int dwNumAreas, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] string[] pszAreas, out IntPtr ppErrors);

    void EnableConditionBySource2([MarshalAs(UnmanagedType.I4)] int dwNumSources, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] string[] pszSources, out IntPtr ppErrors);

    void DisableConditionByArea2([MarshalAs(UnmanagedType.I4)] int dwNumAreas, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] string[] pszAreas, out IntPtr ppErrors);

    void DisableConditionBySource2([MarshalAs(UnmanagedType.I4)] int dwNumSources, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] string[] pszSources, out IntPtr ppErrors);

    void GetEnableStateByArea(
      [MarshalAs(UnmanagedType.I4)] int dwNumAreas,
      [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] string[] pszAreas,
    ...
    void GetEnableStateBySource(
      ...
      [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] string[] pszSources,
      out IntPtr pbEnabled,
      out IntPtr pbEffectivelyEnabled,
      out IntPtr ppErrors);
  }
