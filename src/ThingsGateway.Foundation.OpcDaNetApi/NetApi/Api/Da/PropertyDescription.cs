...
namespace Opc.Da
{
  ...
  public class PropertyDescription
  {
    ...
    {
      foreach (FieldInfo field in typeof (PropertyDescription).GetFields(BindingFlags.Public | BindingFlags.Static))
      {
        PropertyDescription propertyDescription = (PropertyDescription) field.GetValue((object) typeof (PropertyDescription));
    ...
    public static PropertyDescription[] Enumerate()
    {
      ...
      foreach (FieldInfo field in typeof (PropertyDescription).GetFields(BindingFlags.Public | BindingFlags.Static))
        arrayList.Add(field.GetValue((object) typeof (PropertyDescription)));
